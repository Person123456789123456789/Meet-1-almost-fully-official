...
@Disabled
@Autonomous(name = "egg", group = "BLUE")
    ...
    public void runAutonoumousMode() {
        ...
        switch (propPosition) { //UPDATE THESE POSITIONS
            case LEFT:
                ...
                yellowPixelPose = new Pose2d(26, 28, Math.toRadians(-90));
                purplePixelPose = new Pose2d(25, 9, Math.toRadians(0.0));
                break;
            case CENTER:
                telemetry.addData("Center Position", "Center");
               yellowPixelPose = new Pose2d(24, 27,Math.toRadians(-90) );
                purplePixelPose = new Pose2d(28, -5, Math.toRadians(0.0));
                break;
            case RIGHT:
                yellowPixelPose = new Pose2d(33, 29, Math.toRadians(-90));
                telemetry.addData("Right Position", "Right");
                purplePixelPose = new Pose2d(31,-10, Math.toRadians(-60.0));
                break;
