    ...
    public void runAutonoumousMode() {
        ...
        switch (propPosition) { //UPDATE THESE POSITIONS
            case LEFT:
                ...
                wallPose = new Pose2d(2, -2, Math.toRadians(0));
            ...
            case CENTER:
               ...
               wallPose = new Pose2d(2, -2,Math.toRadians(0) );
                ...
                break;
            case RIGHT:
                wallPose = new Pose2d(8, -2, Math.toRadians(0));
                telemetry.addData("Right Position", "Right");
                purplePixelPose = new Pose2d(31,-8, Math.toRadians(-60.0));
                break;

        }
        Pose2d firstparkingPose = new Pose2d(4, -25, 0); //UPDATE
        Pose2d parkingPose = new Pose2d(4, -65, 0); //UPDATE
