...
public class TrajectorySequenceBuilder {
    ...
    CRServo outtake = hardwareMap.get(CRServo.class, "outtake");
    public TrajectorySequenceBuilder spikeMarkOuttake(double power, int time) {
        intake.setPower(power);
        this.waitSeconds(time);
        intake.setPower(0);
        return this;
    }
    public TrajectorySequenceBuilder backdropOuttake(double power, int time) {
